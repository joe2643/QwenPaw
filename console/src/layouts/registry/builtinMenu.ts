...
export const BUILTIN_MENU: MenuItem[] = [
  ...
  // Local addition (not upstream): media server console page.
  {
    id: "core.media-server",
    location: "primary.agentScoped",
    parentId: "core.control-group",
    label: navLabel("nav.mediaServer"),
    icon: SparkDataLine,
    route: "core.media-server",
    order: 45,
  },
  ...
  // Local addition (not upstream): MemPalace memory console page.
  {
    id: "core.mempalace",
    location: "primary.settings",
    parentId: "core.settings-group",
    label: navLabel("nav.mempalace"),
    icon: SparkSaveLine,
    route: "core.mempalace",
    order: 75,
  },
  {
    id: "core.backups",
